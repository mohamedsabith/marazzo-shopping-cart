    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        (this.$rules = {
          ...
          '#variable': [
            {
              ...
              regex: /{{{/,
              push: [
                { token: 'storage.type.variable', regex: /}}}/, next: 'pop' },
                {
          ...
          '#entity': [{ token: 'constant.character.entity', regex: /&\w+;/ }],
          '#list': [
            {
              token: 'markup.bold',
              regex: /^[#*;:]+/,
              push: [
                { token: 'markup.list', regex: /$/, next: 'pop' },
                { include: '$self' },
          ...
          '#template': [
            {
              ...
              regex: /({{)(\s*)([#\w: ]+)(\s*)/,
              push: [
                { token: 'storage.type.function', regex: /}}/, next: 'pop' },
                {
                  token: [
                    'storage',
          ...
          '#th': [
            {
              ...
              regex: /^(\s*)(!)(?:(.*?)(\|))?(.*?)(?=!!|$)/,
              push: [
                { token: 'meta.tag.block.th.heading', regex: /$/, next: 'pop' },
                {
                  token: [
                    'punctuation.definition.tag.begin',
          ...
          '#td': [
            {
              ...
              regex: /^(\s*)(\|)/,
              push: [
                { token: 'meta.tag.block.td', regex: /$/, next: 'pop' },
                { include: '$self' },
          ...
          '#attribute': [
            { include: '#string' },
            { token: 'entity.other.attribute-name', regex: /\w+/ },
          ],
          '#string': [
            {
            ...
            },
            {
              ...
              regex: /\'/,
              push: [
                { token: 'string.quoted.single', regex: /\'/, next: 'pop' },
