      ...
      s = function () {
        (this.$rules = {
          ...
          start: [
            ...
            { token: 'comment.line.number-sign.alda', regex: /#.*$/ },
            { token: 'entity.name.function.pipe.measure.alda', regex: /\|/ },
            {
            ...
            { token: 'keyword.operator.octave-change.alda', regex: /\bo\d+\b/ },
            { token: 'keyword.operator.octave-shift.alda', regex: /[><]/ },
            { token: 'keyword.operator.repeat.alda', regex: /\*\s*\d+/ },
            {
              token: 'string.quoted.operator.timing.alda',
              regex: /[.]|r\d*(?:s|ms)?/,
            },
            { token: 'text', regex: /([cdefgab])/, next: 'pitch' },
            {
              token: 'string.quoted.operator.timing.alda',
              regex: /~/,
              next: 'timing',
            ...
            { token: 'constant.numeric.subchord.alda', regex: /\// },
            {
              todo: {
                token: 'punctuation.section.embedded.cram.alda',
                regex: /\{/,
            ...
            },
            {
              ...
              regex: /\(/,
              push: [
                { token: 'meta.inline.clojure.alda', regex: /\)/, next: 'pop' },
