      ...
      s = function () {
        (this.$rules = {
          start: [
            ...
            { token: 'string.double', regex: /"/, next: 'string-state' },
            {
              token: 'string.regexp',
              regex: '(/)(?=.*/)',
              next: 'pattern-state',
            ...
            { token: 'punctuation.terminator', regex: /;/ },
            ...
            { token: 'keyword.control.conditional', regex: /\b(?:if|else)\b/ },
            ...
            { token: 'keyword.other', regex: /\b(?:add|delete)\b/ },
            ...
            { token: 'storage.type', regex: /\bany\b/ },
            {
              token: 'storage.type',
            ...
            { token: 'punctuation.section.block.end', regex: /\}/ },
            { token: 'punctuation.section.brackets.begin', regex: /\[/ },
            { token: 'punctuation.section.brackets.end', regex: /\]/ },
            { token: 'punctuation.section.parens.begin', regex: /\(/ },
            { token: 'punctuation.section.parens.end', regex: /\)/ },
          ],
          'string-state': [
            { token: 'constant.character.escape', regex: /\\./ },
            { token: 'string.double', regex: /"/, next: 'start' },
            {
          ...
          'pattern-state': [
            { token: 'constant.character.escape', regex: /\\./ },
            { token: 'string.regexp', regex: '/', next: 'start' },
