define(
  ...
  function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        (this.$rules = {
          ...
          '#array': [
            {
              ...
              regex: /\[/,
              push: [
                { token: 'source.prisma.array', regex: /\]/, next: 'pop' },
                { include: '#value' },
          ...
          '#identifier': [
            { token: 'support.constant.constant.prisma', regex: /\b(?:\w)+\b/ },
          ],
          '#map_key': [
            {
              token: [
          ...
          '#named_argument': [{ include: '#map_key' }, { include: '#value' }],
          '#triple_comment': [
            {
              token: 'comment.prisma',
              regex: /\/\/\//,
              push: [
                { token: 'comment.prisma', regex: /$/, next: 'pop' },
    ...
    (s.metaData = { name: 'Prisma', scopeName: 'source.prisma' }),
      r.inherits(s, i),
      (t.PrismaHighlightRules = s);
  }
),
  define(
