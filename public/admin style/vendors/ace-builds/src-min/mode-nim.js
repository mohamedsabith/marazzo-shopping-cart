      ...
      s = function () {
        ...
        (this.$rules = {
          start: [
            ...
            { include: 'methods' },
            { token: e, regex: '[a-zA-Z][a-zA-Z0-9_]*\\b' },
            {
          ...
          docBlockComment: [
            ...
            { regex: /]##/, token: 'comment.doc.end', next: 'pop' },
            { defaultToken: 'comment.doc' },
          ],
          math: [
            { token: 'constant.float', regex: a },
            { token: 'constant.float', regex: u },
            { token: 'constant.integer', regex: s },
          ],
