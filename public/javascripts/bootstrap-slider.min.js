    ...
    (function (a) {
      function b(b, c) {
        ...
        if (this.sliderElem) i = !0;
          ...
          (k.className = 'slider-track'),
            (e = document.createElement('div')),
            (e.className = 'slider-selection'),
            (f = document.createElement('div')),
            (f.className = 'slider-handle min-slider-handle'),
            (g = document.createElement('div')),
            (g.className = 'slider-handle max-slider-handle'),
            k.appendChild(e),
            k.appendChild(f),
            k.appendChild(g);
          var l = function (a) {
          ...
          (o.className = 'tooltip tooltip-max'),
            ...
            j.insertBefore(this.sliderElem, this.element),
        ...
        a &&
          ...
          (c = c ? c : {});
        for (
          var p = Object.keys(this.defaultOptions), q = 0;
          q < p.length;
          q++
        ) {
          var r = p[q],
            s = c[r];
          (s = 'undefined' != typeof s ? s : d(this.element, r)),
            (s = null !== s ? s : this.defaultOptions[r]),
      ...
      if (
        ((d.prototype = {
          ...
          setValue: function (a, b) {
            ...
            this.options.range
              ? ((this.options.value[0] = c(this.options.value[0])),
                (this.options.value[1] = c(this.options.value[1])),
              ...
              : ((this.options.value = c(this.options.value)),
                (this.options.value = [
                  Math.max(
                    this.options.min,
            ...
            var d = this.options.range
              ...
              : this.options.value[0];
            return (
              this._setDataVal(d), b === !0 && this._trigger('slide', d), this
            );
          },
          destroy: function () {
          ...
          on: function (b, c) {
            return (
              a
                ? (this.$element.on(b, c), this.$sliderElem.on(b, c))
                : this._bindNonQueryEventHandler(b, c),
              this
            );
          },
          ...
          refresh: function () {
            return (
              this._removeSliderEventHandlers(),
              b.call(this, this.element, this.options),
            ...
            if (
              ...
              b.right > c.left
                ...
                : (this._removeClass(this.tooltip_max, 'bottom'),
                  this._addClass(this.tooltip_max, 'top'),
                  (this.tooltip_max.style.top = '-30px'));
            }
            var d;
            if (this.options.range) {
              (d = this.options.formatter(this.options.value)),
              ...
              (d = this.options.formatter(this.options.value[0])),
                this._setText(this.tooltipInner, d),
          ...
          _calculateValue: function () {
            ...
            return (
              this.options.range
                ? ((a = [this.options.min, this.options.max]),
                  0 !== this.percentage[0] &&
                    ((a[0] = Math.max(
                      this.options.min,
                      this.options.min +
                ...
                : ((a =
                  ...
                  (a = parseFloat(a)),
                  (a = this._applyPrecision(a)),
                  (this.options.value = [a, this.options.value[1]])),
              a
            );
          },
          ...
          _getPercentage: function (a) {
            !this.touchCapable ||
              ...
              (a = a.touches[0]);
            var b =
              (100 * (a[this.mousePos] - this.offset[this.stylePos])) /
              this.size;
            return (
          ...
          _validateArray: function (a) {
            for (var b = 0; b < a.length; b++) {
              var d = a[b];
              if ('number' != typeof d)
                throw new Error(c.formatInvalidInputErrorMsg(d));
            }
          },
